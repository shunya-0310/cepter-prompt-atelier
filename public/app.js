const CARD_DATA_FILES = [
  {
    ...
    element: "無",
    dataKey: "neutral",
    url: "./assets/carddata/begins-creatures-neutral.tsv?v=20260629-card-update-5",
  },
  {
    tab: "fire",
    label: "火属性",
    ...
    element: "火",
    dataKey: "fire",
    url: "./assets/carddata/begins-creatures-fire.tsv?v=20260629-card-update-5",
  },
  {
    tab: "water",
    label: "水属性",
    ...
    element: "水",
    dataKey: "water",
    url: "./assets/carddata/begins-creatures-water.tsv?v=20260629-card-update-5",
  },
  {
    tab: "earth",
    label: "地属性",
    ...
    element: "地",
    dataKey: "earth",
    url: "./assets/carddata/begins-creatures-earth.tsv?v=20260629-card-update-5",
  },
  {
    tab: "wind",
    label: "風属性",
    ...
    element: "風",
    dataKey: "wind",
    url: "./assets/carddata/begins-creatures-wind.tsv?v=20260629-card-update-5",
  },
  {
    tab: "item",
    label: "アイテム",
    ...
    element: "道具",
    dataKey: "item",
    url: "./assets/carddata/begins-items.tsv?v=20260629-card-update-5",
  },
  {
    tab: "spell",
    label: "スペル",
    ...
    element: "術",
    dataKey: "spell",
    url: "./assets/carddata/begins-spells.tsv?v=20260629-card-update-5",
  },
];
...
const CARD_ID_ALIASES = {
  [stableCardId("spell", "ビギンズ", "ランドプロテクション")]: stableCardId("spell", "ビギンズ", "ランドプロテクト"),
};
...
function resolveStoredCardId(cardId) {
  ...
  const aliased = CARD_ID_ALIASES[value];
  if (aliased && cardsById.has(aliased)) return aliased;
